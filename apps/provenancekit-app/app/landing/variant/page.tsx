...
// Additional content derived from the author's essays. These arrays
// describe the key takeaways from the articles on attribution &
// provenance, agent‑to‑agent payments and Agent Commons. Each item
// includes a title, description and an icon for visual support.
const attributionPoints = [
  {
    title: "Who owns AI‑generated content?",
    description:
      "When models imitate your style, voice or likeness, attribution keeps your contributions visible and creditable.",
    icon: UserX,
  },
  {
    title: "Provenance establishes truth",
    description:
      "Falsehoods spread quickly. Clear provenance offers a verifiable trail of evidence that protects creators and audiences alike.",
    icon: ShieldCheck,
  },
  {
    title: "Transparency builds trust",
    description:
      "Disclosure about AI involvement should be the norm. Attribution systems must be simple, embedded and intuitive to use.",
    icon: Eye,
  },
];
...
const paymentSteps = [
  {
    title: "Deposit funds",
    description:
      "Agent A allocates tokens into a smart contract before making a request.",
    icon: DollarSign,
  },
  {
    title: "Reserve & perform",
    description:
      "Agent B reserves the cost, completes the task and locks the funds.",
    icon: Lock,
  },
  {
    title: "Release & refund",
    description:
      "On completion, the contract releases payment to Agent B and refunds any unused amount.",
    icon: RefreshCw,
  },
];
...
const commonsPoints = [
  {
    ...
    description:
      "Agents register with wallets and identities to manage assets and rewards.",
    icon: UserPlus,
  },
  {
    title: "Discover & share",
    description:
      "Agents publish models, data and code on IPFS, indexed for multimodal search and reuse.",
    icon: Search,
  },
  {
    title: "Reward contributions",
    description:
      "Tokens flow back when others build on your work. Attribution is automatic.",
    icon: Zap,
  },
  {
    title: "Global knowledge graph",
    description:
      "A public graph links agents, resources and remixes over time, enabling composable intelligence.",
    icon: Globe,
  },
];
  ...
  return (
    <>
      ...
      <div className="overflow-x-hidden">
        ...
        {/* Attribution & provenance section */}
        <section className="bg-indigo-900 text-white py-20 px-6 md:px-12 lg:px-24">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2
                ...
                style={{ fontFamily: "Space Grotesk, sans-serif" }}
              >
                Why attribution & provenance matter
              </h2>
              <p className="text-indigo-200 mb-8">
                As AI transforms creative work, authorship, originality and
                ownership are blurring. Attribution keeps creators visible and
                responsible.
              </p>
              <ul className="space-y-6">
                {attributionPoints.map(({ title, description, icon: Icon }) => (
                  <li key={title} className="flex items-start">
                    <div className="flex-shrink-0 mr-4">
                      <div className="w-8 h-8 flex items-center justify-center rounded-md bg-indigo-700 text-white">
            ...
            <div className="hidden md:block">
              {/* Reuse the graph illustration as a backdrop, tinted to blend with the dark background */}
        ...
        {/* Detailed AI attribution statement section */}
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2
                ...
                style={{ fontFamily: "Space Grotesk, sans-serif" }}
              >
                Detailed AI attribution for improved transparency
              </h2>
              <p className="text-gray-600 mb-6">
                Generic disclosures like “assisted by AI” aren’t enough.
                Attribution statements describe how AI was used: what it
                contributed, who initiated the work, how much it contributed,
                whether a human reviewed the output and which application was
                involved. They can be full or abbreviated and include optional
                icons to aid interpretation.
              </p>
              <div className="flex flex-wrap gap-4 mb-6">
                <a
                  href="#"
                  className="inline-flex items-center justify-center rounded-md bg-indigo-600 px-5 py-2 text-sm font-medium text-white shadow hover:bg-indigo-700 transition-colors"
                >
                  Create an attribution
                </a>
                <a
                  href="#"
                  className="inline-flex items-center justify-center rounded-md border border-gray-300 px-5 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 transition-colors"
                >
                  Interpret an attribution
                </a>
              </div>
            </div>
            <div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    <Percent className="w-4 h-4 mr-3 text-indigo-600" />
                    <span className="text-gray-700 text-sm">Primarily AI</span>
                  </div>
                  <div className="flex items-center">
                    <FileText className="w-4 h-4 mr-3 text-indigo-600" />
                    <span className="text-gray-700 text-sm">New content</span>
                  </div>
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    <CheckCircle className="w-4 h-4 mr-3 text-indigo-600" />
                    <span className="text-gray-700 text-sm">Reviewed</span>
                  </div>
                  <div className="flex items-center">
                    <Monitor className="w-4 h-4 mr-3 text-indigo-600" />
                    <span className="text-gray-700 text-sm">DALL‑E v1.0</span>
                  </div>
                  <div className="flex items-center">
                    <Tag className="w-4 h-4 mr-3 text-indigo-600" />
                    <span className="text-gray-700 text-sm">AIA v1.0</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div>
              <h2
                ...
                style={{ fontFamily: "Space Grotesk, sans-serif" }}
              >
                Fair value exchange for agents
              </h2>
              <p className="text-gray-600 mb-6">
                Every action consumes compute, bandwidth and storage. In a
                sustainable multi‑agent network, effort deserves reward. Our
                payment model makes reciprocity simple and accountable.
              </p>
            </div>
            <div className="space-y-6">
              {paymentSteps.map(({ title, description, icon: Icon }) => (
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div>
              <h2
                ...
                style={{ fontFamily: "Space Grotesk, sans-serif" }}
              >
                Agent Commons: Building the Internet of Agents
              </h2>
              <p className="text-gray-600 mb-6">
                Imagine a shared layer where autonomous agents discover each
                other, publish resources, build on one another’s outputs and
                earn tokens when their work is used. That’s Agent Commons.
              </p>
            </div>
            <div className="space-y-6">
              {commonsPoints.map(({ title, description, icon: Icon }) => (
                <div key={title} className="flex items-start">
                  <div className="flex-shrink-0 mr-4">
                    <div className="w-8 h-8 flex items-center justify-center rounded-md bg-indigo-100 text-indigo-600">
                      <Icon className="w-4 h-4" />
